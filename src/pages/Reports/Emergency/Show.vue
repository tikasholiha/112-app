            ...
            <div class="tw-space-x-4">
                <q-btn
                    ...
                    :to="{
                        ...
                        query: {
                            district_ids: tableRows.map((item: any) => item.district?.id).join(','),
                            code: moment(tableRows[0]?.period_date).format('MM'),
                            month:moment(tableRows[0]?.period_date).format('MMMM'),
                        }
                    }"
                >
                    <base-icon
